...
def owner_split(fname,owner,data):
   ...
   #   DES PART
    ...
    fileDES= open("/Users/abhishek/Desktop/input/DES.txt", "w")
    fileDES.write(str(desencrypted.encode("utf-8")))
    fileDES.close()
    start()
    uploadFile('DES.txt',"/Users/abhishek/Desktop/input/DES.txt")
    # AES PART
    ...
    fileAES= open("/Users/abhishek/Desktop/input/AES.txt", "w")
    fileAES.write(str(aesencrypted))
    fileAES.close()
    
    uploadFile('AES.txt',"/Users/abhishek/Desktop/input/AES.txt")
    ...
    fileRSA= open("/Users/abhishek/Desktop/input/RSA.txt", "w")
    fileRSA.write(txt)
    fileRSA.close()
    uploadFile('RSA.txt',"/Users/abhishek/Desktop/input/RSA.txt")
    ...
    try:
        ...
        if dats:
            ...
            #    print('totaldata: %s' % totaldata) 
                ...
                file1 = open("/Users/abhishek/Desktop/input/myfile.txt","w") 
